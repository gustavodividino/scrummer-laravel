    ...
    <div class="row">
        ...
        <div class="col-md-6">
        	...
        	<br>
                ...
                <form class="form-horizontal" method="post" name="signup" id="signup" action="{{URL('profile/result')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-9">
                            <input type="text" class="form-control" name="name" id="name" placeholder="Digite o nome do recurso" value="">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-sm-3">Sobrenome <span class="text-danger"></span></label>
                        <div class="col-md-8 col-sm-9">
                            <input type="text" class="form-control" name="surname" id="surname" placeholder="Digite o sobrenome do recurso" value="">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-sm-3">Habilidades <span class="text-danger"></span></label>
                        <div class="col-md-8 col-sm-9">
							<select class="selectpicker" title="Escolha as Habilidades" id="skills" name="skills[]" multiple="">
